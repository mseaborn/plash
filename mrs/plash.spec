...
cp -v glibc/mrs/NOTES.exec    %{buildroot}/usr/share/doc/plash-%{version}/
...
cp -v glibc/mrs/out-inst-stripped/lib/* %{buildroot}/usr/lib/plash/lib/
cp -v glibc/mrs/out-inst-stripped/ld-linux.so.2 %{buildroot}/usr/lib/plash-chroot-jail/special/
...
cp -v glibc/mrs/exec-object %{buildroot}/usr/bin/exec-object
