...
my @py_decls = ('from plash.marshal import method_id', '');
...
output_data('gensrc/out-marshal.h',
	    "/* Auto-generated by make-marshal.pl */\n",
	    @defines, '',
	    @funs);

output_data('gensrc/out-marshal-examples',
	    "/* Auto-generated by make-marshal.pl */\n",
	    @ex,
	    @ex_call);

output_data('python/plash/methods.py',
	    "# Auto-generated by make-marshal.pl\n",
	    @py_decls);
